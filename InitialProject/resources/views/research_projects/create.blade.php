...
<div class="container">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card" style="padding: 16px;">
            <div class="card-body">
                <h4 class="card-title">{{ __('researchProjects.add_research_project_information') }}</h4>
                <p class="card-description">{{ __('researchProjects.fill_in_research_project_details') }}</p>
                <form action="{{ route('researchProjects.store') }}" method="POST">
                    @csrf
                    <div class="form-group row mt-5">
                        <label for="exampleInputfund_name" class="col-sm-2 ">{{ __('researchProjects.name_of_research_project') }}</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-4">
                            <input type="int" name="budget" class="form-control" placeholder="{{ __('researchProjects.baht_unit') }}" value="{{ old('budget') }}">
                        </div>
                    </div>
                    <div class="form-group row mt-2">
                    ...
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="note" class="form-control form-control-lg" style="height:150px" placeholder="{{ __('researchProjects.budget') }}" value="{{ old('note') }}"></textarea>
                        </div>
                    </div>
                    <div class="form-group row mt-2">
                    ...
                    <div class="form-group row mt-2">
                        <label for="exampleInputfund_details" class="col-sm-2 ">{{ __('researchProjects.person_project') }}</label>
                        <div class="col-sm-9">
