            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">{{ __('dashboard.welcome_text') }} <span
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        document.getElementById ('logout-form').submit();"> {{ __('menudashboard.logout') }} <i class="mdi mdi-logout"></i></a>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <a class="nav-link {{ (request()->is('dashboard*')) ? 'active' : '' }}" href="{{ route('dashboard') }}">
                        ...
                        <span class="menu-title">{{ __('menudashboard.dashboard') }}</span>
                    </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('admin/profile*')) ? 'active' : '' }}"
                            ...
                            <span class="menu-title">{{ __('menudashboard.user_profile') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('funds.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.manage_fund') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('researchProjects.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.research_project') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('researchGroups.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.research_group') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ManagePublications" aria-expanded="false" aria-controls="ManagePublications">
                            ...
                            <span class="menu-title">{{ __('menudashboard.manage_publications') }}</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ManagePublications">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ route('papers.index')}}">{{ __('menudashboard.published_research') }}</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/books">{{ __('menudashboard.book') }}</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/patents">{{ __('menudashboard.other_academic_works') }}</a></li>
                            </ul>
                        </div>
                    </li>
                    @endcan
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('exportfile')}}" >
                            ...
                            <span class="menu-title">{{ __('menudashboard.export') }}</span>
                        </a>
                    </li>
                    @endcan
                    @can('user-list')
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('users.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.users') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('roles.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.roles') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('permissions.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.permissions') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('departments.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.departments') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('programs.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.programs') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('experts.index')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.expertise') }}</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('system.log')}}">
                            ...
                            <span class="menu-title">{{ __('menudashboard.system_log') }}</span>
                        </a>
                    </li>
                    @endcan
                </ul>
