    ...
    <div class="modal" id="myModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h5 class="modal-title"><?php echo e(trans('message.reference_apa')); ?></h5>
...
<script>
    ...
    //- BAR CHART -
    //-------------
    var lang_number = "<?php echo e(__('message.number')); ?>";
    var lang_year = "<?php echo e(__('message.year')); ?>";
    var lang_report_title = "<?php echo e(__('message.report_title')); ?>";
    var lang_summary = "<?php echo e(__('message.summary')); ?>";
    var lang_scopus = "<?php echo e(__('message.scopus')); ?>";
    var lang_wos = "<?php echo e(__('message.wos')); ?>";
    var lang_tci = "<?php echo e(__('message.tci')); ?>";
    ...
    var barChartOptions = {
        ...
        title: {
            display: true,
            text: lang_report_title, // ใช้ตัวแปรภาษา
            fontSize: 20
        }
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project_2-master\git-group-repository-group-4-sec-4\InitialProject\resources\views/home.blade.php ENDPATH**/ ?>